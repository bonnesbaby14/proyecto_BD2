...
include("../../config/db.php"); 
    ...
    if(!$connection) {
        ...
        else
        {
            ...
            $sql="INSERT INTO user(id, user, password, nombre, apellidos,registro,tipo,grado,activo) VALUES(NULL,'$usuario','$password', '$nombre', '$apellidos', '$matricula', 'alumno','$grado' ,'1')";
